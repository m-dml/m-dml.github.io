...
We use hybrid models to better, forecast, simulate and understand the atmosphere and ocean.
...
* Models trained on high-resolution numerical simulations to represent the spatially averaged effect of sub-grid-scale physical, chemical and biological processes on coarser, more computationally efficient model grids.
